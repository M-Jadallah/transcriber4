...
#
# Multi-stage build:
#   1. deps    — install bun, bun install --frozen-lockfile
...
# Coolify auto-passes this when the env var is flagged as "Build Variable".
# The compose file also declares it explicitly under build.args.
